...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ phoneNumber }) => {
  ...
  const message = encodeURIComponent(
    "Olá! Acabei de visitar o showcase do Studio Merali e fiquei impressionado com o trabalho. Gostaria de conversar sobre como podemos elevar meu próximo projeto ao patamar de obra de arte."
  );
